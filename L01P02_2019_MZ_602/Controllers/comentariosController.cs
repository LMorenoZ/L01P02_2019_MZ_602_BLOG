...
namespace L01P02_2019_MZ_602.Controllers
{
    public class comentariosController : Controller
    {
        ...
        public comentariosController(blogDbContextClass context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.comentarios != null ? 
                          ...
                          Problem("Entity set 'blogDbContextClass.comentarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogDbContextClass.comentarios'  is null.");
            }
            var comentarios = await _context.comentarios.FindAsync(id);
            if (comentarios != null)
            {
