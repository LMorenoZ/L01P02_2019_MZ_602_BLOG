...
namespace L01P02_2019_MZ_602.Controllers
{
    public class publicacionesController : Controller
    {
        ...
        public publicacionesController(blogDbContextClass context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.publicaciones != null ? 
                          ...
                          Problem("Entity set 'blogDbContextClass.publicaciones'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogDbContextClass.publicaciones'  is null.");
            }
            var publicaciones = await _context.publicaciones.FindAsync(id);
            if (publicaciones != null)
            {
