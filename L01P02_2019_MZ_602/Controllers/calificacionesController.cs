...
using L01P02_2019_MZ_602.Models;

namespace L01P02_2019_MZ_602.Controllers
{
    public class calificacionesController : Controller
    {
        private readonly blogDbContextClass _context;

        public calificacionesController(blogDbContextClass context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.calificaciones != null ? 
                          ...
                          Problem("Entity set 'blogDbContextClass.calificaciones'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogDbContextClass.calificaciones'  is null.");
            }
            var calificaciones = await _context.calificaciones.FindAsync(id);
            if (calificaciones != null)
            {
